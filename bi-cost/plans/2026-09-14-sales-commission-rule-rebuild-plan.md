...
**Goal:** 按当前实际业务部门重建销售佣金规则，所有有销售人员归属的部门均支持加密业务。
...
- 所有实际业务部门均配置 `crypto` 和其他产品规则；海外业务销售部 - 2 保留直邀/非直邀特殊规则。
...
- [ ] 删除旧的产品白名单限制，保证所有实际业务部门生成 `crypto` 规则。
