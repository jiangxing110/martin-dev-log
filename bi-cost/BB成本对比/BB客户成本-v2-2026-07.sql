-- =============================================================================
-- 母客户级别成本报表 v2 —— 2026-07 月（由 BB客户成本-v2.sql / 2026-01 按月份参数推导生成）
...
-- 已自动按月份推导：日期区间、bb_card_auth_detail_2026-07 分表名。
-- =============================================================================
-- =============================================================================
...
SELECT 
    '2026-07-01'::timestamp AS month_start,          -- 报表月份第一天 00:00:00
    '2026-08-01'::timestamp AS month_end,            -- 报表月份下个月第一天 00:00:00
    '2026-07-01 08:00:00'::timestamp AS txn_start,   -- transaction_time 开始（带时区偏移）
    '2026-08-01 08:00:00'::timestamp AS txn_end,     -- transaction_time 结束（带时区偏移）
    '2026-06-01 00:00:00'::timestamp AS settle_start, -- settle表开始时间前延一个月
    '2026-08-10 00:00:00'::timestamp AS settle_end,   -- settle表结束时间后延一个月
    '2026-07-01'::date AS post_start,                 -- post_date-计算退款 开始时间
    '2026-08-01'::date AS post_end,                   -- post_date-计算退款 结束时间
    '2026-07'::text AS month_label,                   -- 输出月份标签
...
q6 AS (
    ...
    FROM "bb_card_auth_detail_2026-07" A --每月调整
...
1月查询清洗库的成本
Mastercard Domestic Count Fee	9509.7050
Mastercard International Count Fee	71122.6620
VISA Domestic Count Fee	1917.7700
VISA International Count Fee	16464.1320
AC Mastercard Domestic Count Fee	12117.4210
AC Mastercard International Count Fee	7420.6020
AC VISA Domestic Count Fee	1348.7900
AC VISA International Count Fee	3902.8140
Mastercard Domestic Dollar Volume Fee	12979.1265
Mastercard International Dollar Volume Fee	97592.2088
Visa Domestic Dollar Volume Fee	1743.3460
Visa International Dollar Volume Fee	16477.8501
Mastercard International Reversal Fee	3482.1170
Visa International Reversal Fee	6306.7620
Domestic Reversal Fee	1514.4240
Mastercard International Refund Fee	1364.8365
VISA International Refund Fee	4313.0340
Domestic Refund Fee	548.3790
Mastercard International Decline Fee	40105.8200
Visa International Decline Fee	8490.5310
Domestic Decline Fee	11664.0730
AC Mastercard International Decline Fee	2431.2985
AC Visa International Decline Fee	468.3840
AC Domestic Decline Fee	7380.9480
Active Card Account Fee	11907.1000
Volume Fee Cost	79930.8915
Cashback Income	363553.2223
Fixed Fee	0.0000
TOTAL	432505.0259