...
SET myapp.param_e = '1.0526'; --CROSS
...
combined_costs AS (
    SELECT 
        ...
        CASE 
            WHEN cc."母客户id" = '666245' THEN 3290.79+825.5 --每月调整
    ...
    SELECT 
        ...
        END AS "线下实体卡收入",--每月调整
				...
				CASE
						...
						WHEN amc."母客户id" = '761059' THEN 36787.05
        ...
        END) * (COALESCE(cons."QI渠道净消费占比", 0) / 100) AS "财务手动调整返现成本",--每月调整
				...
				CASE
						WHEN amc."母客户id" = '018142' THEN 511.66
						WHEN amc."母客户id" = '128139' THEN 2424.67
						WHEN amc."母客户id" = '148807' THEN 69
						WHEN amc."母客户id" = '174529' THEN 5.6
						WHEN amc."母客户id" = '322383' THEN 6085.47
						...
						WHEN amc."母客户id" = '562513' THEN 0.81
						WHEN amc."母客户id" = '599703' THEN 71.75
						WHEN amc."母客户id" = '637549' THEN 2058.69
						WHEN amc."母客户id" = '838108' THEN 33524.25
						WHEN amc."母客户id" = '990552' THEN 3921.75
						ELSE 0
