...
CREATE TABLE "dws"."dws_qi_card_finance_daily_p" (
  ...
  "cost_reimbursement_rate" numeric(20,4) DEFAULT 0,
  "cost_service_rate" numeric(20,4) DEFAULT 0,
  "cost_acs_regular_rate" numeric(20,4) DEFAULT 0,
  "cost_acs_vip_rate" numeric(20,4) DEFAULT 0,
  "cost_vrm_rate" numeric(20,4) DEFAULT 0,
  "rebate_interchange_rate" numeric(20,4) DEFAULT 0,
  "rebate_incentive_rate" numeric(20,4) DEFAULT 0,
...
COMMENT ON COLUMN "dws"."dws_qi_card_finance_daily_p"."cost_reimbursement_rate" IS 'Reimbursement费用系数(非港净消费额口径)';
COMMENT ON COLUMN "dws"."dws_qi_card_finance_daily_p"."cost_service_rate" IS 'Service Fee费用系数(非港净消费额口径)';
COMMENT ON COLUMN "dws"."dws_qi_card_finance_daily_p"."cost_acs_regular_rate" IS 'ACS普通笔数系数';
COMMENT ON COLUMN "dws"."dws_qi_card_finance_daily_p"."cost_acs_vip_rate" IS 'ACS VIP笔数系数';
COMMENT ON COLUMN "dws"."dws_qi_card_finance_daily_p"."cost_vrm_rate" IS 'VRM验证笔数系数';
COMMENT ON COLUMN "dws"."dws_qi_card_finance_daily_p"."rebate_interchange_rate" IS 'Interchange返现系数(全球净消费额口径)';
COMMENT ON COLUMN "dws"."dws_qi_card_finance_daily_p"."rebate_incentive_rate" IS 'Incentive返现系数(全球净消费额口径)';
