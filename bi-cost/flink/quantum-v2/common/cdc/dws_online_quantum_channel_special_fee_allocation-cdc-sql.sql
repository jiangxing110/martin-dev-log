...
-- Description:    Quantum v2 渠道特殊费用 CDC 月度重算
-- 作业元信息：
--   作业类型：批式 CDC 修复任务
--   运行方式：默认重算当前月；如昨天 CHANNEL_COST 或 BB Auth 有变更，也重算对应月份
--   运行参数：无
-- Notes:
