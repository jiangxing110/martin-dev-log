...
-- Description:    量子卡 BB V2 渠道成本明细查询
-- Usage:
...
bb_detail AS (
    SELECT
        ...
        COALESCE(SUM(bb.v_int_auth_count * 0.4770), 0) AS "bbVisaIntCnt",
        ...
        COALESCE(SUM(bb.ac_m_int_decline_count * 0.3595), 0) AS "bbAcMasterIntDecline",
        COALESCE(SUM(bb.ac_v_int_decline_count * 0.3570), 0) AS "bbAcVisaIntDecline",
        COALESCE(SUM(bb.ac_dom_decline_count * 0.0890), 0) AS "bbAcDomDecline",
