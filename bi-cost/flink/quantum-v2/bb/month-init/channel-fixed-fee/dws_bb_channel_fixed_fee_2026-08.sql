...
FROM (
    ...
    WHERE report_date >= CAST('2026-08-01 00:00:00' AS DATE)
      AND report_date < CAST('2026-08-23 00:00:00' AS DATE)
    UNION
    ...
    WHERE tag = 'CHANNEL_COST' AND provider = 'BB'
      AND statistics_time >= CAST('2026-08-01 00:00:00' AS TIMESTAMP(6)) AND statistics_time < CAST('2026-08-23 00:00:00' AS TIMESTAMP(6))
) m
