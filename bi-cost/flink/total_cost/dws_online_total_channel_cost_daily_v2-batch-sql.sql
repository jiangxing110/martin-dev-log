...
-- Base Script:     dws_online_total_channel_cost_daily-batch-sql.sql
-- Description:    总渠道成本 DWS 批量初始化/回刷 V2
-- 作业元信息：
--   作业类型：批处理
--   运行方式：一次性初始化/回刷或调度执行
...
--   4. V2 调整 BB 量子卡渠道成本口径：补充 clearing volume、AC decline，并修正 dom reversal 费率
--********************************************************************--
