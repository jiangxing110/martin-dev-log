...
COMMENT ON COLUMN "public"."dws_qi_card_finance_daily_p"."id" IS '唯一标识: 日期+账户+销售+AM业务指纹';
...
COMMENT ON COLUMN "public"."dws_qi_card_finance_daily_p"."cost_fixed_fee" IS '固定渠道成本分摊金额';
COMMENT ON TABLE "public"."dws_qi_card_finance_daily_p" IS 'QI渠道财务汇总日表-按年分区';

CREATE INDEX "idx_dws_qi_daily_acc_sale_am" ON "public"."dws_qi_card_finance_daily_p" USING btree (
