...
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."id" IS '主键ID-对应ODS层交易ID';
...
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."transaction_time" IS '交易时间-分区键';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."version" IS '乐观锁版本';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."remarks" IS '备注';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."create_time" IS '记录创建时间';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."update_time" IS '记录更新时间';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."delete_time" IS '逻辑删除时间';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."billing_amount" IS '清算/计费金额(USD)';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."is_qbit_provision" IS '是否Qbit预置卡';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."is_hk_region" IS '是否香港地区交易';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."is_consumption" IS '是否消费类型';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."is_reversal_or_credit" IS '是否冲正或退款';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."has_special_code" IS '是否含特殊码';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."is_vip_account" IS '是否ACS VIP账户';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."business_type" IS '业务类型';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."card_id" IS '卡片ID';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."sale_id" IS '销售ID';
COMMENT ON COLUMN "public"."dwm_qi_card_transaction_detail_p"."am_id" IS 'AM ID';
COMMENT ON TABLE "public"."dwm_qi_card_transaction_detail_p" IS 'QI渠道明细因子层-月度分区表';

CREATE INDEX "idx_dwm_qi_tx_time_acc_sale_am" ON "public"."dwm_qi_card_transaction_detail_p" USING btree (
