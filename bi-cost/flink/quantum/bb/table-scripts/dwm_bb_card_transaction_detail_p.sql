...
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."is_dom" IS '是否本地交易';
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."resp_code" IS '响应码:APPROVE/DECLINE';
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."request_code" IS '请求类型';
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."reason_code" IS '二级原因码';
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."is_valid_settle" IS '是否有效结算';
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."is_clearing" IS '是否清算';
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."is_reversal" IS '是否冲正';
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."is_refund" IS '是否退款';
...
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."sale_id" IS '销售ID';
COMMENT ON COLUMN "public"."dwm_bb_card_transaction_detail_p"."am_id" IS 'AM ID';
COMMENT ON TABLE "public"."dwm_bb_card_transaction_detail_p" IS 'BB渠道明细因子层-月度分区表';

CREATE INDEX "idx_dwm_bb_tx_time_acc_sale_am" ON "public"."dwm_bb_card_transaction_detail_p" USING btree (
