-- =============================================================================
-- 母客户级别成本报表 v2 —— 2026-03 月（由 BB客户成本-v2.sql / 2026-01 按月份参数推导生成）
...
-- 已自动按月份推导：日期区间、bb_card_auth_detail_2026-03 分表名。
-- =============================================================================
-- =============================================================================
...
SELECT 
    '2026-03-01'::timestamp AS month_start,          -- 报表月份第一天 00:00:00
    '2026-04-01'::timestamp AS month_end,            -- 报表月份下个月第一天 00:00:00
    '2026-03-01 08:00:00'::timestamp AS txn_start,   -- transaction_time 开始（带时区偏移）
    '2026-04-01 08:00:00'::timestamp AS txn_end,     -- transaction_time 结束（带时区偏移）
    '2026-02-01 00:00:00'::timestamp AS settle_start, -- settle表开始时间前延一个月
    '2026-04-10 00:00:00'::timestamp AS settle_end,   -- settle表结束时间后延一个月
    '2026-03-01'::date AS post_start,                 -- post_date-计算退款 开始时间
    '2026-04-01'::date AS post_end,                   -- post_date-计算退款 结束时间
    '2026-03'::text AS month_label,                   -- 输出月份标签
...
q6 AS (
    ...
    FROM "bb_card_auth_detail_2026-03" A --每月调整
...
Mastercard Domestic Count Fee	14611.9950
Mastercard International Count Fee	101478.0405
VISA Domestic Count Fee	3777.9025
VISA International Count Fee	24100.4250
AC Mastercard Domestic Count Fee	25566.1680
AC Mastercard International Count Fee	19723.9950
AC VISA Domestic Count Fee	2162.3125
AC VISA International Count Fee	6283.9980
Mastercard Domestic Dollar Volume Fee	10672.2683
Mastercard International Dollar Volume Fee	108103.0997
Visa Domestic Dollar Volume Fee	2127.3681
Visa International Dollar Volume Fee	13399.9639
Mastercard International Reversal Fee	8771.8000
Visa International Reversal Fee	7247.1000
Domestic Reversal Fee	3978.8340
Mastercard International Refund Fee	1801.8555
VISA International Refund Fee	486.5400
Domestic Refund Fee	721.0350
Mastercard International Decline Fee	58459.0140
Visa International Decline Fee	20702.7870
Domestic Decline Fee	29476.6220
AC Mastercard International Decline Fee	4166.9645
AC Visa International Decline Fee	1409.4360
AC Domestic Decline Fee	12436.6820
Active Card Account Fee	16858.6000
Volume Fee Cost	79223.2994
Cashback Income	359874.6278
Fixed Fee	0.0000
TOTAL	577748.1058