-- ==============================================================
-- 增量物化视图：dws.dws_revenue_summary_daily_mv
...
COMMENT ON MATERIALIZED VIEW dws.dws_revenue_summary_daily_mv IS '收入日维度汇总（dws_revenue_daily + channel_cashback_daily），增量自动刷新';
