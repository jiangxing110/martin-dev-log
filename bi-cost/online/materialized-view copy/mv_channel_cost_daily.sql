...
DROP MATERIALIZED VIEW IF EXISTS "dws"."mv_channel_cost_daily_v2";

CREATE MATERIALIZED VIEW "dws"."mv_channel_cost_daily_v2" AS
...
ALTER MATERIALIZED VIEW "dws"."mv_channel_cost_daily_v2"
    OWNER TO "qbit_admin";

CREATE UNIQUE INDEX IF NOT EXISTS "idx_mv_channel_cost_daily_v2_id"
    ON "dws"."mv_channel_cost_daily_v2" ("id");

CREATE INDEX IF NOT EXISTS "idx_mv_channel_cost_daily_v2_date_account"
    ON "dws"."mv_channel_cost_daily_v2"
    ("report_date", "account_id");

COMMENT ON MATERIALIZED VIEW "dws"."mv_channel_cost_daily_v2" IS
    '总渠道成本日汇总普通物化视图，每 5 小时全量刷新';

-- 手动全量刷新：
-- REFRESH MATERIALIZED VIEW "dws"."mv_channel_cost_daily_v2";
--
-- 手动并发刷新：
-- REFRESH MATERIALIZED VIEW CONCURRENTLY
--     "dws"."mv_channel_cost_daily_v2";
