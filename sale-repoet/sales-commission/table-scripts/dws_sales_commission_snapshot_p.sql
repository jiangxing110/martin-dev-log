...
COMMENT ON TABLE "dws"."dws_sales_commission_snapshot_p" IS '销售佣金发薪快照主表，每月8号按展示用户固化汇总，展示用户命中明细sale_id或am_id';
COMMENT ON COLUMN "dws"."dws_sales_commission_snapshot_p"."id" IS '唯一标识，按snapshot_date、settlement_month、展示用户ID生成';
...
COMMENT ON COLUMN "dws"."dws_sales_commission_snapshot_p"."sale_id" IS '展示用户ID，取命中明细sale_id或am_id的用户ID';
