...
LEFT JOIN "qbitCard" AS qc ON tr."cardId" = qc."id"
        ...
        LOOP
            IF p_dry_run THEN
                EXECUTE format('SELECT COUNT(*) FROM public.dws_qbit_card_transaction_%s WHERE (a, c, c, o, u, n, t, _, i, d, ,,  , p, r, o, v, i, d, e, r, ,,  , b, i, n, ,,  , b, u, s, i, n, e, s, s, _, t, y, p, e, ,,  , c, r, e, a, t, e, _, d, a, t, e, ,,  , s, t, a, t, u, s) IN (SELECT DISTINCT tr."accountId", tr."provider", qc."firstSix" AS "bin", tr."businessType", CURRENT_DATE, tr."status" FROM "qbit_card_transaction" AS tr
LEFT JOIN "qbitCard" AS qc ON tr."cardId" = qc."id" WHERE FALSE)', v_year) INTO v_n;
            ELSE
                EXECUTE format('DELETE FROM public.dws_qbit_card_transaction_%s WHERE (a, c, c, o, u, n, t, _, i, d, ,,  , p, r, o, v, i, d, e, r, ,,  , b, i, n, ,,  , b, u, s, i, n, e, s, s, _, t, y, p, e, ,,  , c, r, e, a, t, e, _, d, a, t, e, ,,  , s, t, a, t, u, s) IN (SELECT DISTINCT tr."accountId", tr."provider", qc."firstSix" AS "bin", tr."businessType", CURRENT_DATE, tr."status" FROM "qbit_card_transaction" AS tr
