...
BEGIN
    IF p_start IS NULL THEN
        ...
        LOOP
            IF p_dry_run THEN
                EXECUTE format('SELECT COUNT(*) FROM public.dws_qbit_card_group_transaction_%s WHERE (a, c, c, o, u, n, t, _, i, d, ,,  , b, u, s, i, n, e, s, s, _, t, y, p, e, ,,  , c, r, e, a, t, e, _, d, a, t, e, ,,  , s, t, a, t, u, s) IN (SELECT DISTINCT tr."accountId", tr."businessType", CURRENT_DATE, tr."status" FROM "qbitCardGroupTransaction" AS tr WHERE FALSE)', v_year) INTO v_n;
            ELSE
                EXECUTE format('DELETE FROM public.dws_qbit_card_group_transaction_%s WHERE (a, c, c, o, u, n, t, _, i, d, ,,  , b, u, s, i, n, e, s, s, _, t, y, p, e, ,,  , c, r, e, a, t, e, _, d, a, t, e, ,,  , s, t, a, t, u, s) IN (SELECT DISTINCT tr."accountId", tr."businessType", CURRENT_DATE, tr."status" FROM "qbitCardGroupTransaction" AS tr WHERE FALSE)', v_year);
